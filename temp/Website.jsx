...
export function Model(props) {
  ...
  return (
    ...
    <group {...props} dispose={null}>
      ...
      <spotLight intensity={500} angle={0.885} penumbra={0.5} decay={2} position={[1.434, 10.398, -32.131]} rotation={[-Math.PI / 2, 0, 0]} target={nodes.Spot.target}>
      ...
      <group position={[-29.007, 3.086, 4.763]} rotation={[0, -0.343, Math.PI]} scale={[7, 2, 7]}>
        <HoverableMesh geometry={nodes.Cone010_1.geometry} material={materials['Material.026']} />
